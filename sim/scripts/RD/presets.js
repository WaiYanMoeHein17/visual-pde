...
// =============================================
// ADER-DG Test Presets
// =============================================

// Test 1a: Linear Advection with Gaussian - Order 1
presets["aderDGAdvection1D_O1"] = {
  boundaryConditions_1: "periodic",
  dimension: "1",
  diffusionStr_1_1: "0",
  dt: 0.001,
  dgOrder: 1,
  domainScale: "10",
  initCond_1: "exp(-((x-L_x/4)^2)/(2*0.5^2))",
  kineticParams: "c = 1;",
  numSpecies: 1,
  numTimestepsPerFrame: 50,
  plotType: "line",
  preset: "aderDGAdvection1D_O1",
  reactionStr_1: "-c*u_x",
  renderSize: 512,
  spatialStep: "0.05",
  speciesNames: "u",
  squareCanvas: false,
  timesteppingScheme: "ADER-DG",
  timeDisplay: true,
  views: [
    {
      autoSetColourRange: false,
      ...
      minColourValue: "-0.2",
      whatToPlot: "u",
      name: "Advecting Gaussian",
    },
  ],
  simTitle: "ADER-DG Advection Test (Order 1)",
};

// Test 1a: Linear Advection with Gaussian - Order 2
presets["aderDGAdvection1D_O2"] = {
  boundaryConditions_1: "periodic",
  dimension: "1",
  diffusionStr_1_1: "0",
  dt: 0.001,
  ...
  simTitle: "ADER-DG Advection Test (Order 2)",
};

// Test 1a: Linear Advection with Gaussian - Order 3
presets["aderDGAdvection1D_O3"] = {
  boundaryConditions_1: "periodic",
  dimension: "1",
  diffusionStr_1_1: "0",
  dt: 0.0005,
  ...
  simTitle: "ADER-DG Advection Test (Order 3)",
};

// Test 1a: Linear Advection with Gaussian - Order 4
presets["aderDGAdvection1D_O4"] = {
  boundaryConditions_1: "periodic",
  dimension: "1",
  diffusionStr_1_1: "0",
  dt: 0.0003,
  ...
  simTitle: "ADER-DG Advection Test (Order 4)",
};

// Test 1b: Square Wave Advection
presets["aderDGSquareWave1D"] = {
  boundaryConditions_1: "periodic",
  dimension: "1",
  diffusionStr_1_1: "0",
  dt: 0.001,
  dgOrder: 2,
  domainScale: "10",
  initCond_1: "ind(x > L_x/4 && x < L_x/2)",
  kineticParams: "c = 1;",
  numSpecies: 1,
  numTimestepsPerFrame: 50,
  plotType: "line",
  preset: "aderDGSquareWave1D",
  reactionStr_1: "-c*u_x",
  renderSize: 512,
  spatialStep: "0.05",
  speciesNames: "u",
  ...
  views: [
    {
      ...
      minColourValue: "-0.2",
      whatToPlot: "u",
      name: "Advecting Square Wave",
    },
  ],
  simTitle: "ADER-DG Square Wave Test",
};

// Test 2: Wave Equation (1D) - reformulated as first-order system
presets["aderDGWave1D"] = {
  boundaryConditions_1: "periodic",
  boundaryConditions_2: "periodic",
  dimension: "1",
  diffusionStr_1_1: "0",
  ...
  dgOrder: 2,
  domainScale: "10",
  initCond_1: "exp(-((x-L_x/2)^2)/(2*0.3^2))",
  initCond_2: "0",
  kineticParams: "D = 1;",
  numSpecies: 2,
  numTimestepsPerFrame: 50,
  ...
  simTitle: "ADER-DG Wave Equation Test",
};

// Test 4: CFL Stability Test
presets["aderDGCFLTest"] = {
  boundaryConditions_1: "periodic",
  dimension: "1",
  diffusionStr_1_1: "0",
  dt: 0.005,
  ...
  simTitle: "ADER-DG CFL Stability Test",
};

// Test 5: 2D ADER-DG Wave Equation (with damping)
presets["aderDG2DWave"] = {
  boundaryConditions_1: "periodic",
  boundaryConditions_2: "periodic",
  dimension: "2",
  diffusionStr_1_1: "0",
  ...
  initCond_1: "0",
  initCond_2: "0",
  kineticParams: "c = 1; gamma = 0.1;",
  numSpecies: 2,
  numTimestepsPerFrame: 100,
  preset: "aderDG2DWave",
  reactionStr_1: "v",
  reactionStr_2: "c*c*Lapu - gamma*v",
  renderSize: 512,
  spatialStep: "0.1",
  speciesNames: "u,v",
  squareCanvas: false,
  ...
  simTitle: "ADER-DG 2D Wave Equation",
};

// ADER-DG Shallow Water Equations
presets["aderDGShallowWater"] = {
  boundaryConditions_1: "periodic",
  boundaryConditions_2: "periodic",
  boundaryConditions_3: "periodic",
  brushAction: "smoothreplace",
  ...
  whatToDraw: "h",
  whatToPlot: "h",
  simTitle: "ADER-DG Shallow Water Equations",
};

// Test 6: 2D ADER-DG Diffusion
presets["aderDG2DDiffusion"] = {
  boundaryConditions_1: "periodic",
  dimension: "2",
  diffusionStr_1_1: "D",
  dt: 0.001,
